...
public class StellMapClient implements AutoCloseable {

    private static final Logger log = LoggerFactory.getLogger(StellMapClient.class);
    ...
    private static final StellMapRequestNormalizer REQUEST_NORMALIZER = new StellMapRequestNormalizer();
    ...
    public StellMapClient(StellMapClientOptions options, OpenTelemetry openTelemetry) {
        ...
        log.debug(
                "Initialized StellMapClient baseUrl={}, autoDeregisterOnClose={}, watchAutoReconnect={}",
                this.baseUri,
                normalizedSettings.autoDeregisterOnClose(),
    ...
    StellMapRequestNormalizer requestNormalizerInternal() {
    ...
    private Duration resolveHeartbeatInterval(long leaseTtlSeconds) {
        long ttl = leaseTtlSeconds > 0L ? leaseTtlSeconds : StellMapDefaults.DEFAULT_LEASE_TTL_SECONDS;
